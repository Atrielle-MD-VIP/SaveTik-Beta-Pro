...
let serverFaqsConfig: { active: boolean; subheading: string; faqs: any[] } = {
  active: true,
  subheading: "Jawaban lengkap seputar download video yang sering kalian tanya kan",
  faqs: [
    {
      question: "Ini beneran download video gratis?",
      answer: "Ya, 100% gratis tanpa batasan jumlah unduhan."
    },
    {
      question: "Apakah butuh login akun?",
      answer: "Tidak perlu. langsung download video tanpa mendaftar."
    },
    {
    ...
    {
      question: "Apakah mendownload video ada iklan?",
      answer: "Pertanyaan Baguss, 100% tidak ada iklan yang mengganggu kalian"
    },
    {
      question: "Apakah Hasil Downloadan Video HD?",
      answer: "Ya 100% hasil downloadan video kalian sangat HD"
    },
    {
      question: "Kenapa download video ada jeda cooldown 20 detik?",
      answer: "Karena Jeda, cooldown diterapkan untuk menghindari spamming pada server kami dan menjaga kestabilan sistem download."
    }
  ]
};
